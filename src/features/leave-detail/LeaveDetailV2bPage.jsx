            ...
            <div className="ldb-card">
              ...
              <div className="ldb-v3-details-grid">
                ...
                <div className="ldb-detail-row">
                  ...
                  <span className="ldb-detail-value">Jun 03, 2026</span>
                </div>
                <div className="ldb-detail-row">
                  <span className="ldb-detail-label">Leave End</span>
                  <span className="ldb-detail-value">Aug 24, 2026</span>
                </div>
                <div className="ldb-detail-row">
            ...
            <div className="ldb-card">
              ...
              <div className="ldb-v2-timeline">
                <div className="ldb-v2-coverage-bars">
                  <div className="ldb-v2-bar-row">
                    ...
                    <div className="ldb-v2-bar-tooltip">
                      ...
                      <div className="ldb-v2-ms-tooltip-date">Jun 03 – Aug 24, 2026</div>
                  ...
                  <div className="ldb-v2-bar-row">
                    ...
                    <div className="ldb-v2-bar-tooltip">
                      ...
                      <div className="ldb-v2-ms-tooltip-date">Jun 03 – Jul 05, 2026</div>
                  ...
                  <div className="ldb-v2-bar-row">
                    ...
                    <div className="ldb-v2-bar-tooltip">
                      ...
                      <div className="ldb-v2-ms-tooltip-date">Jun 24 – Aug 12, 2026</div>
                      <div className="ldb-v2-ms-tooltip-desc">85% of average weekly wage up to state max ($1,055/wk). Bonding period begins after delivery.</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ldb-v2-timeline-legend">
                  ...
                  <span className="ldb-legend-item"><span className="ldb-legend-dot pfml" />NJ FLI</span>
                ...
                <div className="ldb-tab-content">
                  <div className="ldb-payment-summary">
                    <div className="ldb-payment-box">
                      ...
                      <div className="ldb-payment-box-value">$8,265.00</div>
                    </div>
                    <div className="ldb-payment-box">
                      <div className="ldb-payment-box-label">NEXT EXPECTED PAYMENT</div>
                      <div className="ldb-payment-box-value">Jul 26, 2026</div>
                    </div>
                    <div className="ldb-payment-box">
                      <div className="ldb-payment-box-label">EST. WEEKLY (NJ FLI)</div>
                      <div className="ldb-payment-box-value">$1,055.00</div>
                    </div>
                  </div>
                  ...
                  <table className="ldb-claims-table ldb-payments-table">
                    ...
                    <tbody>
                      ...
                      {expandedPayments.p4 && (
                        <tr className="ldb-pmt-expand-row"><td colSpan="5">
                          <div className="ldb-pmt-expand-grid">
                            <div className="ldb-pmt-expand-item"><span className="ldb-pmt-expand-label">Gross Pay</span><span className="ldb-pmt-expand-value">$1,055.00</span></div>
                            <div className="ldb-pmt-expand-item"><span className="ldb-pmt-expand-label">Adjustments</span><span className="ldb-pmt-expand-value">$0.00</span></div>
                            <div className="ldb-pmt-expand-item"><span className="ldb-pmt-expand-label">Tax &amp; Deductions</span><span className="ldb-pmt-expand-value">$0.00</span></div>
                            <div className="ldb-pmt-expand-item"><span className="ldb-pmt-expand-label">Net Amount</span><span className="ldb-pmt-expand-value ldb-pmt-net">$1,055.00</span></div>
                            <div className="ldb-pmt-expand-item"><span className="ldb-pmt-expand-label">Paid By</span><span className="ldb-pmt-expand-value">NJ Family Leave Insurance</span></div>
                          </div>
                        </td></tr>
                      )}
                      <tr>
              ...
              <div className="ldb-doc-list">
                <div className="ldb-doc-item">
                  ...
                  <div className="ldb-doc-info">
                    ...
                    <div className="ldb-doc-meta">May 13, 2026 &middot; 1.2 MB</div>
                  </div>
                ...
                <div className="ldb-doc-item">
                  ...
                  <div className="ldb-doc-info">
                    ...
                    <div className="ldb-doc-meta">May 06, 2026 &middot; 2.4 MB</div>
                  </div>
                  <button type="button" className="ldb-icon-btn" aria-label="Download">
                    <svg width="12" height="12" viewBox="0 0 16 16" fill="none"><path d="M8 2v9M4.5 7.5L8 11l3.5-3.5M3 13h10" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </button>
            ...
            <div className="ldb-side-card">
                  ...
                  <div className="ldb-task-timeline">
                    <div className="ldb-task-tl-item done">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Completed Jun 5, 2026</div>
                      </div>
                    ...
                    <div className="ldb-task-tl-item done">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Completed Jun 8, 2026</div>
                      </div>
                      <span className="ldb-task-tl-badge done">Done</span>
                    </div>
                    <div className="ldb-task-tl-item done">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Approved Jun 10, 2026</div>
                      </div>
                      <span className="ldb-task-tl-badge done">Done</span>
                    </div>
                  </div>
                  ...
                  <div className="ldb-task-timeline">
                    <div className="ldb-task-tl-item done">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Completed Jun 3, 2026</div>
                      </div>
                      <span className="ldb-task-tl-badge done">Done</span>
                    </div>
                    <div className="ldb-task-tl-item urgent">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Due by Jul 24, 2026</div>
                      </div>
                    ...
                    <div className="ldb-task-tl-item pending">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Due by Aug 24, 2026</div>
                      </div>
              ...
              <div className="ldb-task-group">
                <button type="button" className={'ldb-task-group-header ldb-accordion-toggle' + (openAccordions.pfml ? ' open' : '')} onClick={function () { toggleAccordion('pfml'); }}>
                  ...
                  <span className="ldb-task-group-label">NJ FLI</span>
                  ...
                  <div className="ldb-task-timeline">
                    <div className="ldb-task-tl-item done">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">Completed Jun 25, 2026</div>
                      </div>
                      <span className="ldb-task-tl-badge done">Done</span>
                    </div>
                    <div className="ldb-task-tl-item in-progress">
                      ...
                      <div className="ldb-task-tl-content">
                        ...
                        <div className="ldb-task-tl-meta">In progress since Jul 1, 2026</div>
                      </div>
