            ...
            <div className="ldb-card dt-timeline-wrap">
                ...
                <div style={{ padding: '16px 0 0' }}>
                  ...
                  <div style={{ border: '1px solid #e5e7eb', borderRadius: 6, overflow: 'hidden' }}>
                    {/* Months row */}
                    <div style={{ display: 'flex', background: '#f9fafb', borderBottom: '1px solid #e5e7eb', padding: '6px 0', paddingLeft: 50 }}>
                    ...
                    {/* Weeks row — 12 slots aligned with months, showing cumulative week count */}
                    <div style={{ display: 'flex', background: '#fff', borderBottom: '1px solid #e5e7eb', padding: '4px 0', paddingLeft: 50 }}>
                    ...
                    {/* Timeline bars */}
                    <div className="ldb-tl-rows-wrap" style={{ display: 'flex', flexDirection: 'column', gap: 0, position: 'relative', padding: '8px 12px 8px 0', paddingLeft: 50 }}>
